...
if (isMobileDevice()) {
  ...
  <div
    class="sub-link"
    onclick="copyText('https://raw.githubusercontent.com/MatinGhanbari/v2ray-configs/main/subscriptions/v2ray/subs/trojan.txt')"
  >
    .../subscriptions/v2ray/subs/trojan.txt
  </div>
`;
} else {
  sub.innerHTML += `
  ...
  <div
    ...
    onclick="copyText('https://raw.githubusercontent.com/MatinGhanbari/v2ray-configs/main/subscriptions/v2ray/subs/trojan.txt')"
  >
    https://raw.githubusercontent.com/MatinGhanbari/v2ray-configs/main/subscriptions/v2ray/subs/trojan.txt
  </div>
`;
}
